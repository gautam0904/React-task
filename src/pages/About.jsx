        ...
        <div className="w-full min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 flex flex-col items-center py-8 px-2">
            {/* Breadcrumb */}
                  <nav className="w-full max-w-4xl text-xs sm:text-sm text-gray-300 mb-4 sm:mb-6">
                    ...
                    <span className="ml-2 text-white font-semibold">About</span>
                  </nav>

            <h1 className="text-xl sm:text-2xl font-bold mb-4">About Page</h1>
            <p className="text-sm sm:text-base">Enthusiastic Full Stack Developer with 24+ months of hands-on experience in the MEAN-MERN stack
